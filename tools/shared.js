...
(function() {
    if (localStorage.getItem('sw_clean_v65')) return;
    ...
    navigator.serviceWorker.getRegistrations().then(function(regs) {
        ...
        Promise.all(promises).then(function() {
            localStorage.setItem('sw_clean_v65', '1');
            location.reload();
        });
    });
})();
...
function initNav(activePage) {
    ...
    var labels = mobile ? ['Calc', 'Data', 'Home', 'Pay', 'Wallet'] : ['Calculator', 'Data', 'Dashboard', 'Payouts', 'Wallet'];
    nav.innerHTML =
...
(function() {
    var pages = ['calculator.html', 'charts.html', 'index.html', 'payouts.html', 'wallet.html'];
    ...
    function generate() {
        ...
        for (var n = 0; n < NODE_COUNT; n++) {
            nodes.push({
                ...
                maxOpacity: 0.025 + Math.random() * 0.05,
